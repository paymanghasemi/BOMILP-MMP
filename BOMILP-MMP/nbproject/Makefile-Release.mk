...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk BOMILP-MMP

BOMILP-MMP: /opt/CPLEX/12.7/cplex/lib/x86-64_linux/static_pic/libilocplex.a

BOMILP-MMP: /opt/CPLEX/12.7/cplex/lib/x86-64_linux/static_pic/libcplex.a

BOMILP-MMP: /opt/CPLEX/12.7/concert/lib/x86-64_linux/static_pic/libconcert.a

BOMILP-MMP: ${OBJECTFILES}
	${LINK.cc} -o BOMILP-MMP ${OBJECTFILES} ${LDLIBSOPTIONS}
